...
class DetalleReservas(var id: Int, var idReserva: Int, var idLugar: Int,  var estado: Int, var fecha: String, var hora_ini: String, var hora_fin: String, var createdAt: Long, var updatedAt: Long) : Parcelable {
